...
const PLANS = [
  {
    ...
    priceId: "price_1Tlc1vDAmkJ2t1TLd329Uotw",
    features: [
  ...
  },
  {
    ...
    price: "$134.97",
    period: "/3 months",
    description: "10% discount — paid in full upfront",
    priceId: "price_1Tlc1vDAmkJ2t1TLoxtxlz3v",
    badge: "Save 10%",
    features: [
      "Everything in Monthly",
      "10% discount vs. month-to-month",
  ...
  },
  {
    ...
    priceId: "price_1Tlc1vDAmkJ2t1TLfOzdp2ua",
    badge: "Save 20%",
    popular: true,
    features: [
      "Everything in 3-Month",
      "Best value — 20% off vs. monthly",
